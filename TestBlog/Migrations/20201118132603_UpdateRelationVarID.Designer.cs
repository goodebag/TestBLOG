...
namespace TestBlog.Migrations
{
    ...
    [Migration("20201118132603_UpdateRelationVarID")]
    partial class UpdateRelationVarID
    {
            ...
            modelBuilder.Entity("TestBlog.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PostId = 1,
                            CommentsId = 0,
                            Date = new DateTime(2020, 11, 18, 14, 26, 2, 929, DateTimeKind.Local).AddTicks(2150),
                            Discription = 2,
